![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/KAUTH/git-lfs-hooks)
[![GitHub license](https://img.shields.io/github/license/KAUTH/git-lfs-hooks)](https://github.com/KAUTH/git-lfs-hooks/blob/main/LICENSE)
...
- The version in [.version](https://github.com/KAUTH/git-lfs-hooks/blob/main/.version)
corresponds to the supported Git LFS version.
...
With this repository, the `pre-commit` framework and Git LFS can both use the hooks
with no issues.
...
scenario, this solution is not necessary.
...
## License
[MIT License](https://github.com/KAUTH/git-lfs-hooks/blob/main/LICENSE)
